...
$this->any('historic-search', 'BalanceController@searchHistoric')->name('hisotric.search');
...
$this->post('confirmar-transfer' , 'BalanceController@confirmar')->name('confirm.transfer');
...
$this->get('deposit' , 'BalanceController@desposit')->name('balance.deposit');
